 ...
 *
 * @package CoursePress
 * Description: Adds Average Grade which can be used as a shortcode in Basic Certificate of CoursePress Pro Version 2.2.2. This is a stand alone php file which must be placed inside the mu-plugins folder. Shortcode -> STUDENT_FINAL_GRADE
 */
